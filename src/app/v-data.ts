export const HomeHeroData = [
    {
        description: "Crie sistemas robustos e preparados para o futuro! Com um código escalável, seu projeto se mantém organizado, de fácil manutenção e pronto para crescer junto com suas necessidades. Desenvolva com qualidade, eficiência e performance. 🚀",
        btnText: "Saiba mais",
        btnSeconday: "Portfolio"
    },
];

export const carouselTecIconsData = [
    {
        icon: "/react.svg"
    },
    {
